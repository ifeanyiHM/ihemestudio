      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center w-full">
        ...
        <div>
          <div className="inline-flex items-center gap-3 pl-3 pr-4 py-2 border border-teal-border bg-teal-subtle mb-8">
            ...
            <span className="text-teal text-xs font-mono uppercase tracking-[0.12em]">
              Available for new projects
            </span>
          </div>

          <h1 className="font-display text-white mb-6 leading-[1.05] tracking-tight text-[clamp(2.25rem,5vw,3.75rem)] font-bold">
            We build software that scales.
            {/* <em className="text-gradient not-italic">scales.</em> */}
          </h1>

          <p className="max-w-xl text-slate-light font-light text-[clamp(1rem,1.5vw,1.125rem)] leading-relaxed mb-10">
        ...
        <div className="relative hidden lg:block h-[520px]">
          ...
          {/* Floating card 1 — top */}
          <div className="absolute top-8 right-6 w-56 rounded-xl border border-white/[0.08] bg-ink-800/80 backdrop-blur-md p-5  animate-float-slow">
            <div className="flex items-center gap-2 mb-3">
              <div className="w-8 h-8 rounded-lg bg-teal-subtle border border-teal-border flex items-center justify-center">
                <FiCode size={14} className="text-teal" />
              </div>
          ...
          <div className="absolute top-[42%] left-2 w-52 rounded-xl border border-white/[0.08] bg-ink-800/80 backdrop-blur-md p-5 shadow-card-hover animate-float-slower">
            <div className="flex items-center gap-2 mb-3">
              <div className="w-8 h-8 rounded-lg bg-teal-subtle border border-teal-border flex items-center justify-center">
                <FiLayers size={14} className="text-teal" />
              </div>
              <span className="text-white text-sm font-semibold">
                Design Systems
              </span>
          ...
          <div className="absolute bottom-10 right-10 w-48 rounded-xl border border-white/[0.08] bg-ink-800/80 backdrop-blur-md p-5 shadow-card-hover animate-float-slow">
            <div className="flex items-center gap-2 mb-3">
              <div className="w-8 h-8 rounded-lg bg-teal-subtle border border-teal-border flex items-center justify-center">
                <FiZap size={14} className="text-teal" />
              </div>
              <span className="text-white text-sm font-semibold">
                Fast Delivery
              </span>
