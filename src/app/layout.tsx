...
export const metadata: Metadata = {
  ...
  keywords: ["software engineering","web development","Next.js","React","TypeScript","frontend engineering","full-stack development","Lagos Nigeria"],
  ...
  openGraph: {
    ...
    description: "We build high-performance web applications, enterprise dashboards, and digital products.",
    images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "Iheme Studio" }],
  },
  twitter: {
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${inter.variable} ${syne.variable} ${jetbrainsMono.variable}`} suppressHydrationWarning>
      <head><JsonLd data={organizationSchema} /></head>
      <body>
        <CursorGlow />
        <Navbar />
        <main>{children}</main>
